...
{
    public partial class frm_playerinfo_dubs : Form
    {
        string sheet_id;

        private static frm_playerinfo_dubs instance;
        public frm_playerinfo_dubs()
        {
            InitializeComponent();
        ...
        public static frm_playerinfo_dubs GetInstance
        {
            get
            {
                if (instance == null || instance.IsDisposed)
                {
                    instance = new frm_playerinfo_dubs();
                }
                return instance;
            }
        }
        ...
        private player_info _player3_name = new player_info();
        public player_info player3_name
        {
            get { return _player3_name; }
            set
            {
                _player3_name = value;
                lvw_playerinfo.Items[0].SubItems[3].Text = _player3_name.tag;
                lvw_playerinfo.Items[1].SubItems[3].Text = _player3_name.twitter;
                lvw_playerinfo.Items[2].SubItems[3].Text = _player3_name.region;
                lvw_playerinfo.Items[3].SubItems[3].Text = _player3_name.sponsor;
                lvw_playerinfo.Items[4].SubItems[3].Text = _player3_name.character[0];
            }
        }

        private player_info _player4_name = new player_info();
        public player_info player4_name
        {
            get { return _player4_name; }
            set
            {
                _player4_name = value;
                lvw_playerinfo.Items[0].SubItems[4].Text = _player4_name.tag;
                lvw_playerinfo.Items[1].SubItems[4].Text = _player4_name.twitter;
                lvw_playerinfo.Items[2].SubItems[4].Text = _player4_name.region;
                lvw_playerinfo.Items[3].SubItems[4].Text = _player4_name.sponsor;
                lvw_playerinfo.Items[4].SubItems[4].Text = _player4_name.character[0];
            }
        }
        ...
        private player_info update_player(player_info updating_player)
        {
            ...
            if (player_info_box.ShowDialog() == DialogResult.OK)
            {
                ...
                string range = "Current Round Info!A6:I18";
                ...
                if (player_information[0][5].ToString() == global_values.roster[change_roster].tag)
                {
                    Google.Apis.Sheets.v4.Data.ValueRange update_player_range = new Google.Apis.Sheets.v4.Data.ValueRange();
                    update_player_range.Values = new List<IList<object>> { player_oblist };
                    //Set the range's row to the player index"
                    update_player_range.Range = "Current Round Info!F6:F10";
                    update_player_range.MajorDimension = "COLUMNS";

                    data.Add(update_player_range);
                }

                if (player_information[0][7].ToString() == global_values.roster[change_roster].tag)
                {
                    Google.Apis.Sheets.v4.Data.ValueRange update_player_range = new Google.Apis.Sheets.v4.Data.ValueRange();
                    update_player_range.Values = new List<IList<object>> { player_oblist };
                    //Set the range's row to the player index"
                    update_player_range.Range = "Current Round Info!H6:H10";
                    update_player_range.MajorDimension = "COLUMNS";

                    data.Add(update_player_range);
                }

                if (player_information[8][5].ToString() == global_values.roster[change_roster].tag)
                {
                    Google.Apis.Sheets.v4.Data.ValueRange update_player_range = new Google.Apis.Sheets.v4.Data.ValueRange();
                    update_player_range.Values = new List<IList<object>> { player_oblist };
                    //Set the range's row to the player index"
                    update_player_range.Range = "Current Round Info!F14:F18";
                    update_player_range.MajorDimension = "COLUMNS";

                    data.Add(update_player_range);
                }

                if (player_information[8][7].ToString() == global_values.roster[change_roster].tag)
                {
                    Google.Apis.Sheets.v4.Data.ValueRange update_player_range = new Google.Apis.Sheets.v4.Data.ValueRange();
                    update_player_range.Values = new List<IList<object>> { player_oblist };
                    //Set the range's row to the player index"
                    update_player_range.Range = "Current Round Info!H14:H18";
                    update_player_range.MajorDimension = "COLUMNS";
        ...
        {
            player3_name = update_player(_player3_name);
        }

        private void btn_player4_Click(object sender, EventArgs e)
        {
            player4_name = update_player(_player4_name);
        }
    }
}
