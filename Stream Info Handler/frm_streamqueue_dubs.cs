...
{
    public partial class frm_streamqueue_dubs : Form
    {
        ...
        {
            this.Activated -= frm_streamqueue_dubs_Activated;
            this.Deactivate -= frm_streamqueue_dubs_Deactivate;
            load_queue();
            this.Activated += frm_streamqueue_dubs_Activated;
            this.Deactivate += frm_streamqueue_dubs_Deactivate;
        }

        public frm_streamqueue_dubs(string sheetid)
        {
            InitializeComponent();
            ...
            load_queue();
            init_refresh();
            frm_playerinfo_dubs.GetInstance.Show();
        }
        ...
        public void load_queue()
        {
            ...
            List<string> ranges = new List<string>(new string[] { "Upcoming Matches!A1:G56", "Player Information!A2:O" + (frm_main.MAX_PLAYERS + 1).ToString() });
            ...
            player_name[3] = upcoming_matches[4 + round_number][3].ToString();
                ...
                cbx_player3.Focused == false && cbx_player4.Focused == false)
            {
                ...
                cbx_player3.Items.Clear();                                            //Empty the item list
                cbx_player4.BeginUpdate();                                            //Begin
                cbx_player4.Items.Clear();                                            //Empty the item list

                for (int i = 0; i <= global_values.roster_size; i++)
                {
                    cbx_player1.Items.Add(global_values.roster[i].tag);
                    cbx_player2.Items.Add(global_values.roster[i].tag);
                    cbx_player3.Items.Add(global_values.roster[i].tag);
                    cbx_player4.Items.Add(global_values.roster[i].tag);
                }
            ...
            for (int i = 1; i <= 50; i++)
            {
                if (upcoming_matches[3 + i][1].ToString() != "")
                {
                    ...
                    add_item.SubItems.Add(upcoming_matches[3 + i][4].ToString());
                    add_item.SubItems.Add(upcoming_matches[3 + i][5].ToString());
                    if (i == round_number)
                    {
        ...
        private void lvw_matches_SelectedIndexChanged(object sender, EventArgs e)
        {
                ...
                cbx_player3.Focused == false && cbx_player4.Focused == false)
            {
                ...
                for (int i = 0; i <= global_values.roster_size; i++)
                {
                    ...
                    {
                        frm_playerinfo_dubs.GetInstance.player1_name = global_values.roster[i];
                        frm_playerinfo_dubs.GetInstance.BringToFront();
                        break;
                    }
                }
                for (int i = 0; i <= global_values.roster_size; i++)
                {
                    ...
                    {
                        frm_playerinfo_dubs.GetInstance.player2_name = global_values.roster[i];
                        frm_playerinfo_dubs.GetInstance.BringToFront();
                        break;
                    }
                }
                for (int i = 0; i <= global_values.roster_size; i++)
                {
                    if (global_values.roster[i].tag == lvw_matches.SelectedItems[0].SubItems[4].Text)
                    {
                        frm_playerinfo_dubs.GetInstance.player3_name = global_values.roster[i];
                        frm_playerinfo_dubs.GetInstance.BringToFront();
                        break;
                    }
                }
                for (int i = 0; i <= global_values.roster_size; i++)
                {
                    if (global_values.roster[i].tag == lvw_matches.SelectedItems[0].SubItems[5].Text)
                    {
                        frm_playerinfo_dubs.GetInstance.player4_name = global_values.roster[i];
                        frm_playerinfo_dubs.GetInstance.BringToFront();
                        break;
                    }
                }
        ...
        private void frm_streamqueue_dubs_FormClosed(object sender, FormClosedEventArgs e)
        {
            frm_playerinfo_dubs.GetInstance.Close();
        }
        ...
        private void update_new_match()
        {
            ...
            for (int i = 0; i <= global_values.roster_size; i++)
            {
                ...
                {
                    frm_playerinfo_dubs.GetInstance.player1_name = empty_info;
                }
            }
            for (int i = 0; i <= global_values.roster_size; i++)
            {
                ...
                if (global_values.roster_size == i)
                {
                    frm_playerinfo_dubs.GetInstance.player2_name = empty_info;
                }
            }
            for (int i = 0; i <= global_values.roster_size; i++)
            {
                if (global_values.roster[i].tag == cbx_player3.Text)
                {
                    frm_playerinfo_dubs.GetInstance.player3_name = global_values.roster[i];
                    break;
                }
                if (global_values.roster_size == i)
                {
                    frm_playerinfo_dubs.GetInstance.player3_name = empty_info;
                }
            }
            for (int i = 0; i <= global_values.roster_size; i++)
            {
                if (global_values.roster[i].tag == cbx_player4.Text)
                {
                    frm_playerinfo_dubs.GetInstance.player4_name = global_values.roster[i];
                    break;
                }
                if (global_values.roster_size == i)
                {
                    frm_playerinfo_dubs.GetInstance.player4_name = empty_info;
                }
            }
        }
        ...
        private void cbx_player3_Enter(object sender, EventArgs e)
        {
            update_new_match();
        }

        private void cbx_player3_TextChanged(object sender, EventArgs e)
        {
            update_new_match();
        }

        private void cbx_player4_Enter(object sender, EventArgs e)
        {
            update_new_match();
        }

        private void cbx_player4_TextChanged(object sender, EventArgs e)
        {
            update_new_match();
        }
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i <= 50; i++)
            {
                ...
                else
                {
                    ...
                    add_item.SubItems.Add(new_player3);
                    add_item.SubItems.Add(new_player4);
                    if (i == round_number)
                    {
                        add_item.BackColor = current_match_color;
                    }
            ...
            upcoming.Range = "Upcoming Matches!B" + new_match.ToString() + ":F" + new_match.ToString();
            ...
            if ((round_number + 5) == new_match)
            {
                ...
                player_info player_info3 = new player_info();
                player_info player_info4 = new player_info();
                ...
                for (int i = 0; i <= global_values.roster_size; i++)
                {
                    if (global_values.roster[i].tag == new_player3)
                    {
                        player_info3 = global_values.roster[i];
                        break;
                    }
                }
                for (int i = 0; i <= global_values.roster_size; i++)
                {
                    if (global_values.roster[i].tag == new_player4)
                    {
                        player_info4 = global_values.roster[i];
                        break;
                    }
                }

                // The new values to apply to the spreadsheet.
                var oblist1 = new List<object>() { "Next Match", "TEAM1 P1", "Tag:", "Twitter:", "Region:", "Sponsor:", "Character:" };
                ...
                var oblist3 = new List<object>() { upcoming_matches[6 + round_number][1].ToString(), "TEAM1 P2", "Tag:", "Twitter:", "Region:", "Sponsor:", "Character:" };
                ...
                var oblist5 = new List<object>() { "", "TEAM2 P1", "Tag:", "Twitter:", "Region:", "Sponsor:", "Character:" };
                var oblist6 = new List<object>() { "", "", player_info3.tag, player_info3.twitter, player_info3.region, player_info3.sponsor, player_info3.character[0] };
                var oblist7 = new List<object>() { "", "TEAM2 P2", "Tag:", "Twitter:", "Region:", "Sponsor:", "Character:" };
                var oblist8 = new List<object>() { "", "", player_info4.tag, player_info4.twitter, player_info4.region, player_info4.sponsor, player_info4.character[0] };


                upcoming = new Google.Apis.Sheets.v4.Data.ValueRange();
                upcoming.Values = new List<IList<object>> { oblist1, oblist2, oblist3, oblist4, oblist5, oblist6, oblist7, oblist8 };
                upcoming.Range = "Current Round Info!A12:H18";
        ...
        private void btn_reset_Click(object sender, EventArgs e)
        {
            ...
            var oblist3 = new List<object>() { "Round", "Team 1 Player 1", "Team 1 Player 2", "Team 2 Player 1", "Team 2 Player 2" };
            ...
            upcoming.Range = "Upcoming Matches!B2:F54";
            upcoming.MajorDimension = "ROWS";
        ...
        private void btn_moveup_Click(object sender, EventArgs e)
        {
            ...
            var oblist = new List<object>() { upcoming_matches[3 + move_index][1].ToString(), upcoming_matches[3 + move_index][2].ToString(), upcoming_matches[3 + move_index][3].ToString(), upcoming_matches[3 + move_index][4].ToString(), upcoming_matches[3 + move_index][5].ToString() };
            var oblist2 = new List<object>() { upcoming_matches[2 + move_index][1].ToString(), upcoming_matches[2 + move_index][2].ToString(), upcoming_matches[2 + move_index][3].ToString(), upcoming_matches[2 + move_index][4].ToString(), upcoming_matches[2 + move_index][5].ToString() };

            // The new values to apply to the spreadsheet.
            Google.Apis.Sheets.v4.Data.ValueRange upcoming = new Google.Apis.Sheets.v4.Data.ValueRange();
            upcoming.Values = new List<IList<object>> { oblist, oblist2 };
            upcoming.Range = "Upcoming Matches!B" + (move_index + 3).ToString() + ":F" + (move_index + 4).ToString();
            upcoming.MajorDimension = "ROWS";
                ...
                selected_index == round_number+1 || selected_index - 1 == round_number + 1)))
            {
                ...
                string[] update_players = { lvw_matches.Items[round_number - 1].SubItems[2].Text,
                                    ...
                                    lvw_matches.Items[round_number - 1].SubItems[4].Text,
                                    lvw_matches.Items[round_number - 1].SubItems[5].Text,
                                    lvw_matches.Items[next_match - 1].SubItems[2].Text,
                                    lvw_matches.Items[next_match - 1].SubItems[3].Text,
                                    lvw_matches.Items[next_match - 1].SubItems[4].Text,
                                    lvw_matches.Items[next_match - 1].SubItems[5].Text};
                ...
                upcoming = new Google.Apis.Sheets.v4.Data.ValueRange();
                upcoming.Values = new List<IList<object>> { uoblist1, uoblist2, uoblist3, uoblist4, uoblist5, uoblist6, uoblist7, uoblist8 };
                upcoming.Range = "Current Round Info!A4:H18";
                upcoming.MajorDimension = "COLUMNS";
        ...
        private void add_to_queue(int queue_number, int differential, int current_round, int next_round, IList<IList<object>> sheet_info)
        {
            ...
            add_item.SubItems.Add(sheet_info[differential + queue_number][4].ToString());
            add_item.SubItems.Add(sheet_info[differential + queue_number][5].ToString());
        ...
        private void btn_push_Click(object sender, EventArgs e)
        {
            ...
            string player3 = lvw_matches.SelectedItems[0].SubItems[4].Text;
            string player4 = lvw_matches.SelectedItems[0].SubItems[5].Text;
            ...
            for (int i = 0; i <= global_values.roster_size; i++)
            {
                if (global_values.roster[i].tag == player3)
                {
                    player_info3 = global_values.roster[i];
                    break;
                }
            ...
            for (int i = 0; i <= global_values.roster_size; i++)
            {
                if (global_values.roster[i].tag == player4)
                {
                    player_info4 = global_values.roster[i];
                    break;
                }
            ...
            var oblist1 = new List<object>() { "Next Match", "TEAM1 P1", "Tag:", "Twitter:", "Region:", "Sponsor:", "Character:" };
            var oblist2 = new List<object>() { "", "", player_info1.tag, player_info1.twitter, player_info1.region, player_info1.sponsor, player_info1.character[0] };
            var oblist3 = new List<object>() { round, "TEAM1 P2", "Tag:", "Twitter:", "Region:", "Sponsor:", "Character:" };
            var oblist4 = new List<object>() { "", "", player_info2.tag, player_info2.twitter, player_info2.region, player_info2.sponsor, player_info2.character[0] };
            var oblist5 = new List<object>() { "", "TEAM2 P1", "Tag:", "Twitter:", "Region:", "Sponsor:", "Character:" };
            var oblist6 = new List<object>() { "", "", player_info3.tag, player_info3.twitter, player_info3.region, player_info3.sponsor, player_info3.character[0] };
            var oblist7 = new List<object>() { "", "TEAM2 P2", "Tag:", "Twitter:", "Region:", "Sponsor:", "Character:" };
        ...
        private void btn_remove_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Are you sure you want to remove this match?\n" +
                                ...
                                lvw_matches.SelectedItems[0].SubItems[2].Text + " & " + lvw_matches.SelectedItems[0].SubItems[3].Text + " vs. " + 
                                lvw_matches.SelectedItems[0].SubItems[4].Text + " & " + lvw_matches.SelectedItems[0].SubItems[5].Text, "Confirm Match Removal",
                                MessageBoxButtons.OKCancel) != DialogResult.OK)
            {
                return;
            }
            ...
            for (int i = 1; i <= lvw_matches.Items.Count; i++)
            {
                var oblist = new List<object>() { lvw_matches.Items[i-1].SubItems[1].Text,
                    ...
                    lvw_matches.Items[i-1].SubItems[4].Text, lvw_matches.Items[i-1].SubItems[5].Text,};
                upcoming.Values.Add(oblist);
            }
            var lastlist = new List<object>() { "", "", "" };
            upcoming.Values.Add(lastlist);

            upcoming.Range = "Upcoming Matches!B2:F" + (lvw_matches.Items.Count + 5).ToString();
            upcoming.MajorDimension = "ROWS";
        ...
        private void btn_edit_Click(object sender, EventArgs e)
        {
            ...
            var edit_match = new frm_edit_match_dubs(match, round, player1, player2, player3, player4, cbx_player1.Items);
        ...
        private void frm_streamqueue_dubs_Activated(object sender, EventArgs e)
        {
            if (reactivate == true)
            {
                reactivate = false;
        ...
        private void frm_streamqueue_dubs_Deactivate(object sender, EventArgs e)
        {
            reactivate = true;
        }
    }
